...
impl TABBY_CIPHER {
    fn new(ciphersuite: SupportedCipherSuite) -> TABBY_CIPHER {
        TABBY_CIPHER {
            magic: *MAGIC,
            ciphersuite,
        }
...
pub extern "C" fn tabby_TLS_method() -> *const TABBY_METHOD {
    ...
    let method = TABBY_METHOD::new(versions, ClientOrServerMode::Both);
...
pub extern "C" fn tabby_TLS_client_method() -> *const TABBY_METHOD {
    let method = TABBY_METHOD::new(vec![&TLS12, &TLS13], ClientOrServerMode::Client);
    Box::into_raw(Box::new(method))
}
...
pub extern "C" fn tabby_TLSv1_2_client_method() -> *const TABBY_METHOD {
    let method = TABBY_METHOD::new(vec![&TLS12], ClientOrServerMode::Client);
    Box::into_raw(Box::new(method))
}
...
pub extern "C" fn tabby_TLSv1_3_client_method() -> *const TABBY_METHOD {
    let method = TABBY_METHOD::new(vec![&TLS13], ClientOrServerMode::Client);
    Box::into_raw(Box::new(method))
}
...
pub extern "C" fn tabby_TLS_server_method() -> *const TABBY_METHOD {
    let method = TABBY_METHOD::new(vec![&TLS12, &TLS13], ClientOrServerMode::Server);
    Box::into_raw(Box::new(method))
}
...
pub extern "C" fn tabby_TLSv1_2_server_method() -> *const TABBY_METHOD {
    let method = TABBY_METHOD::new(vec![&TLS12], ClientOrServerMode::Server);
    Box::into_raw(Box::new(method))
}
...
pub extern "C" fn tabby_TLSv1_3_server_method() -> *const TABBY_METHOD {
    let method = TABBY_METHOD::new(vec![&TLS13], ClientOrServerMode::Server);
    Box::into_raw(Box::new(method))
}
...
fn inner_tabby_ssl_cipher_get_version(cipher_ptr: *mut TABBY_CIPHER) -> *const c_char {
...
pub extern "C" fn tabby_SSL_connect(ssl_ptr: *mut TABBY_SSL) -> c_int {
    check_inner_result!(inner_tabby_ssl_connect(ssl_ptr), SSL_FAILURE)
}
...
mod tests {
    ...
    impl TabbyTestSession {
        fn new_client_session(
            ...
            assert_eq!(SSL_SUCCESS, tabby_SSL_connect(ssl), "Failed to connect");
    ...
    fn ssl_io_on_bad_file_descriptor() {
        ...
        assert_eq!(SSL_SUCCESS, tabby_SSL_connect(ssl));
